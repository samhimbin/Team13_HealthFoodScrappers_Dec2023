package com.RecipeCategory;
	...
	public class Vegan_Lunch  extends InitClass {
		...
		public void veganLunchRecipe() throws InterruptedException, IOException {
			...
			xlUtil.setCellData("Vegan lunch", 0, 0, "RecipeID");
			xlUtil.setCellData("Vegan lunch", 0, 1, "RecipeName");
			xlUtil.setCellData("Vegan lunch", 0, 2, "Recipe Category(lunch/lunch/snack/lunch)");
			xlUtil.setCellData("Vegan lunch", 0, 3, "Food Category(Veg/non-veg/vegan/Jain)");
			xlUtil.setCellData("Vegan lunch", 0, 4, "Ingredients");
			xlUtil.setCellData("Vegan lunch", 0, 5, "Preparation Time");
			xlUtil.setCellData("Vegan lunch", 0, 6, "Cooking Time");
			xlUtil.setCellData("Vegan lunch", 0, 7, "Preparation method");
			xlUtil.setCellData("Vegan lunch", 0, 8, "Nutrient values");
			xlUtil.setCellData("Vegan lunch", 0, 9, "Targetted morbid conditions (Diabeties/Hypertension/Hypothyroidism)");
			xlUtil.setCellData("Vegan lunch", 0, 10, "Recipe URL");
