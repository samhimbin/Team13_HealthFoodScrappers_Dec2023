package com.RecipeCategory;
	...
	public class Vegan_Breakfast  extends InitClass {
		...
		public void veganBreakfastRecipe() throws InterruptedException, IOException {
			...
			xlUtil.setCellData("Vegan breakfast", 0, 0, "RecipeID");
			xlUtil.setCellData("Vegan breakfast", 0, 1, "RecipeName");
			xlUtil.setCellData("Vegan breakfast", 0, 2, "Recipe Category(Breakfast/lunch/snack/breakfast)");
			xlUtil.setCellData("Vegan breakfast", 0, 3, "Food Category(Veg/non-veg/vegan/Jain)");
			xlUtil.setCellData("Vegan breakfast", 0, 4, "Ingredients");
			xlUtil.setCellData("Vegan breakfast", 0, 5, "Preparation Time");
			xlUtil.setCellData("Vegan breakfast", 0, 6, "Cooking Time");
			xlUtil.setCellData("Vegan breakfast", 0, 7, "Preparation method");
			xlUtil.setCellData("Vegan breakfast", 0, 8, "Nutrient values");
			xlUtil.setCellData("Vegan breakfast", 0, 9, "Targetted morbid conditions (Diabeties/Hypertension/Hypothyroidism)");
			xlUtil.setCellData("Vegan breakfast", 0, 10, "Recipe URL");
