package com.RecipeCategory;
	...
	public class Vegan_Dinner  extends InitClass {
		...
		public void veganDinnerRecipe() throws InterruptedException, IOException {
			...
			xlUtil.setCellData("Vegan dinner", 0, 0, "RecipeID");
			xlUtil.setCellData("Vegan dinner", 0, 1, "RecipeName");
			xlUtil.setCellData("Vegan dinner", 0, 2, "Recipe Category(dinner/lunch/snack/dinner)");
			xlUtil.setCellData("Vegan dinner", 0, 3, "Food Category(Veg/non-veg/vegan/Jain)");
			xlUtil.setCellData("Vegan dinner", 0, 4, "Ingredients");
			xlUtil.setCellData("Vegan dinner", 0, 5, "Preparation Time");
			xlUtil.setCellData("Vegan dinner", 0, 6, "Cooking Time");
			xlUtil.setCellData("Vegan dinner", 0, 7, "Preparation method");
			xlUtil.setCellData("Vegan dinner", 0, 8, "Nutrient values");
			xlUtil.setCellData("Vegan dinner", 0, 9, "Targetted morbid conditions (Diabeties/Hypertension/Hypothyroidism)");
			xlUtil.setCellData("Vegan dinner", 0, 10, "Recipe URL");
