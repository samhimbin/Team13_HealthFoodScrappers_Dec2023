package com.RecipeCategory;
	...
	public class Vegan_Snacks  extends InitClass {
		...
		public void veganSeganSnacksRecipe() throws InterruptedException, IOException {
			...
			xlUtil.setCellData("Vegan", 0, 0, "RecipeID");
			xlUtil.setCellData("Vegan", 0, 1, "RecipeName");
			xlUtil.setCellData("Vegan", 0, 2, "Recipe Category(Breakfast/lunch/snack/dinner)");
			xlUtil.setCellData("Vegan", 0, 3, "Food Category(Veg/non-veg/vegan/Jain)");
			xlUtil.setCellData("Vegan", 0, 4, "Ingredients");
			xlUtil.setCellData("Vegan", 0, 5, "Preparation Time");
			xlUtil.setCellData("Vegan", 0, 6, "Cooking Time");
			xlUtil.setCellData("Vegan", 0, 7, "Preparation method");
			xlUtil.setCellData("Vegan", 0, 8, "Nutrient values");
			xlUtil.setCellData("Vegan", 0, 9, "Targetted morbid conditions (Diabeties/Hypertension/Hypothyroidism)");
			xlUtil.setCellData("Vegan", 0, 10, "Recipe URL");
