...
public class Diabeties_Eliminate extends InitClass {
	...
	public void scrapeDiabeticRecipe() throws InterruptedException, IOException {
		...
		excelReader.createExcel("DiabetesRecipes_Eliminated");
		...
		for (int page = 1; page <= pageSize; page++) {
			...
			for (Object eachRecipe : link) {
				...
				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 0, recipeId);
				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 1, recipeName);
				...
				for (int j = 0; j < acceptedRecipeCatList.size(); j++) {
					...
					excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 2, recipeCatListPresent.toString());
				}
				...
				for (int j = 0; j < acceptedFoodCatList.size(); j++) {
					...
					excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 3, foodCatListPresent.toString());
				}
				foodCatListPresent.clear();

				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 4, ingredients);
				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 5, prepartionTime);
				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 6, cookingTime);
				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 7, preparationMethod);
				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 8, nutrient);
				...
				for (int j = 0; j < targetedMorbidCondList.size(); j++) {
					...
					if (tagstext.contains(tarMorbidCondition)) {
						...
						excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 9,
								morbidCondListPresent.toString());
					}
				}
				excelReader.setCellData("DiabetesRecipes_Eliminated", cell, 10, recipeUrl);
