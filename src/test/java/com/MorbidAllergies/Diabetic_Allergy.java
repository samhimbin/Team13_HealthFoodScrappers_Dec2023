...
public class Diabetic_Allergy extends InitClass {

	@Test
	public void scrapeDiabeticAllergyRecipe() throws InterruptedException, IOException {
		...
		excelReader.createExcel("Diabetes_Eliminate_Allergies");
